...
#include "system.h"
/*!
 * \brief класс, который перерисовывает связи после нажатия на помеченные или непомеченные эллипсы
 * (когда пользователь соединяет или разъединяет связи между шинами)
 */
